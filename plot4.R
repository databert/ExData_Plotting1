...
# Plot 1
plot(df.sub[, fulldate], df.sub[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(df.sub[, fulldate], df.sub[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
# Plot 4
plot(df.sub[, fulldate], df.sub[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
